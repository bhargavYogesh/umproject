...
String apiKey = "ca4bb255806ef88877b499d8d114e875";
...
void loop() {
  ...
  serverr.handleClient();
  lcd.clear();
  lcd.print(F("Credit:WEB-CLOUD ART"));
  serverr.handleClient();
  chineseTextReveal(5, 2, "BHARGAV ");
  serverr.handleClient();
  delay(1000);
  serverr.handleClient();
...
void parseJson(const char * jsonString) {
  ...
  diffDataAction(weatherNow, weatherLater, "Thunderstorm ");
  diffDataAction(weatherNow, weatherLater, "Drizzle ");
  diffDataAction(weatherNow, weatherLater, "Dust");
